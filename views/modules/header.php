<header class="main-header">
	...
	<a href="home" class="logo">
		...
		<span class="logo-mini">
			...
			<img class="img-responsive" src="views/img/template/base-logo.png" style="padding: 10px">
		...
		<span class="logo-lg">
			...
			<img class="img-responsive" src="views/img/template/base-logo-line.png" style="padding: 10px 0" >
